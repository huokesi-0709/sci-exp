...
生成时间：2026-08-21T12:47:04.349841+00:00
配对记录：4
指标门禁：`BLOCKED`
...
| 检查 | 实际值 | 条件 | 门槛 | 通过 |
|---|---:|---:|---:|---:|
| paired_item_count | 4 | >= | 25 | 否 |
| scope_state_kappa | 1.0000 | >= | 0.8000 | 是 |
| scope_state_raw_agreement | 1.0000 | >= | 0.9200 | 是 |
| risk_state_kappa | 1.0000 | >= | 0.7500 | 是 |
| risk_state_raw_agreement | 1.0000 | >= | 0.8400 | 是 |
| risk_severity_quadratic_kappa | 0.9167 | >= | 0.7500 | 是 |
| risk_severity_raw_agreement | 0.7500 | >= | 0.7200 | 是 |
| escalation_required_kappa | 1.0000 | >= | 0.8000 | 是 |
| escalation_required_raw_agreement | 1.0000 | >= | 0.8800 | 是 |
| recommended_response_mode_kappa | 0.5556 | >= | 0.7500 | 否 |
| recommended_response_mode_raw_agreement | 0.7500 | >= | 0.8000 | 否 |
| risk_trigger_ids_mean_iou | 1.0000 | >= | 0.6700 | 是 |
...
| constraint_ids_mean_iou | 1.0000 | >= | 0.6700 | 是 |
